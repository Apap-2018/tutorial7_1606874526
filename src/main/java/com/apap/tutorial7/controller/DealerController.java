...
public class DealerController {
	...
	public Optional<DealerModel> viewDealer(@PathVariable ("dealerId") long dealerId, Model model) {
		return dealerService.getDealerDetailById(dealerId);
	}
	
	// delete
	@DeleteMapping(value = "/delete")
	private String deleteDealerById(@RequestParam("dealerIdd") long id) {
	...
	// view all dealer
	@GetMapping()
	public List<DealerModel> viewAllDealer(Model model) {
